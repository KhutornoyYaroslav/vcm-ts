...
def main():
    ...
    parser.add_argument('--src-root', dest='src_root', type=str,
                        default="/home/alexnevskiy/PycharmProjects/vcm-ts/data/huawei/sources/train/test_0/test_0.mp4",
                        help="Path to dataset root directory or to video file")
    parser.add_argument('--dst-root', dest='dst_root', type=str,
                        default="/home/alexnevskiy/PycharmProjects/vcm-ts/data/huawei/outputs/train/test_0",
